...
if len(sys.argv) > 1:
    ...
    # experiment_name_three = "20150814AN"
    experiment_name_three = "20150814AN_01"
...
dtrend_three = docdbi.query(experiment_name=experiment_name_three,
                     generated_by_name=action_type, block_number=0)[0]
dtrend_four = docdbi.query(experiment_name=experiment_name_four,
                     generated_by_name=action_type, block_number=0)[0]
# tmean.fslview()
...
dtrend_one.fslview(with_ims=[dtrend_two, dtrend_three, dtrend_four])
