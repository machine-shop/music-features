...
## fake data
## i don't remember how this was different from model02.py
## it seems like the test data was fake bold data again and
## it had a specific standard deviation of nosie added to it.
...
teststim = [ 
             "boldlike_stdnoise1.0_iter0",
             "boldlike_stdnoise1.0_iter1",
             "boldlike_stdnoise1.0_iter2",
             "boldlike_stdnoise1.0_iter3",
             "boldlike_stdnoise1.0_iter4",
             "boldlike_stdnoise1.0_iter5",
             "boldlike_stdnoise1.0_iter6",
             "boldlike_stdnoise1.0_iter7",
             "boldlike_stdnoise1.0_val0",
             "boldlike_stdnoise1.0_val1"
           ]
