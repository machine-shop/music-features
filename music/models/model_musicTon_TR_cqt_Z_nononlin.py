...
## exploring tonotopic maps using music; tonotopy range (29 bands)
## one session of music data

## same as musicTon_TR_cqt_noZ_nononlin.py except that now all stimuli
## are zscored before the model fit
...
# Parameters to set
endTrim = False
modelname = 'musicTon_TR_cqt_Z_nononlin_SA'
...
## TODO: update with the cqt extraction parameters in order to name the submodels
