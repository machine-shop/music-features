...
## this is the formisano_range of frequencies; no zscoring stimuli, only centering
## simple alpha, 10 boots, trim the first and last 5 TRs
## session 1; fit full brain, but can also fit for just auditory cortex
...
# Parameters to set
endTrim = False
modelname = 'musicTon_FR_cqt_noZ_nononlin'
...
cqt_range = 'FR_range' # TODO: update with the appropriate frequency range
fmin = 186
num_bins = 36
bins_per_octave = 7
