...
## piano range of frequencies
## one session of music data
## using this script I looked at single alpha (10 boots), and multiple
## alpha fits (50 boots); stimuli not zscored only centered
## no nonlinearity applied before temporal downsampling
## trim the first and last five TRs; fit full brain; 4 delays
...
# Parameters to set
endTrim = False
modelname = 'musicTon_PR_cqt_noZ_nononlin_SA'
...
cqt_range = 'piano_range' # TODO: update with the appropriate frequency range
...
# TODO: update with the correct set of features used
featset = ['cqt_{0}'.format(cqt_range)] 
...
inface.dict2cloud(outfile, dict(models=featset,
                              wt=wt,
                              corr=corr,
