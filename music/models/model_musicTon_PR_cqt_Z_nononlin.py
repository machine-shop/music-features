...
## piano range of frequencies; single session

## same as model_musicTon_PR_cqt_noZ_nononlin.py except that
## the stimuli matrices were zscored before the model fit.
...
# Parameters to set
endTrim = False
modelname = 'musicTon_PR_cqt_Z_nononlin_MA'
