...
## exploring tonotopic maps using music, cqt features
## modFR_cqt (modified formisano range)
## one session of music data

## using this script did both zscored and not zscored (just centered)
## stimuli, by adjusting the operation (i.e, zscore, center) down below
## single alpha; 10 boots; trim the first and last 5 TRs
## fit full brain; no nonlinearity was applied before temporal downsampling
...
# Parameters to set
endTrim = False
modelname = 'musicTon_modFR_cqt_noZ_nononlin'
...
cqt_range = 'modFR_range' # TODO: update with the appropriate frequency range
fmin = 100
num_bins = 36
bins_per_octave = 6
