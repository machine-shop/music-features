...
## this is the speech equivalent of music's model_ak.py (the one that is missing)
## this is the last model fit summer 2015 for Lucine's SURF, when doing the final comparison
## against music (model_ak.py)
