...
## using cqt feature extracted over formisano range
## one session of speech
## no zscoring, only centering; 4 delays
## fit on full human brain
## no nonlinearity applied prior to temporal downsampling
## single alpha; 10 boots; trim first and last 5 TRS
...
# Parameters to set
endTrim = False
modelname = "speechTon_cqt_noZ_FR_nononlin"
